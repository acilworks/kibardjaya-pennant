...
@section('content')
    ...
    ============================================ --}}
    <section class="about-process" style="border-bottom: 1px solid #1a1a1a; background-color: #DFDFDF; overflow: hidden;">
                ...
                <div class="swiper-slide about-process__item">
                    <div style="padding: 60px 40px; height: 100%;">
                        <span
                            ...
                            — The Studio</span>
                        <h3 style="font-size: 24px; font-weight: 700; text-transform: uppercase; margin: 0 0 20px 0;">
                            Handmade Production</h3>
                        <p style="font-size: 13px; font-weight: 300; line-height: 1.6; max-width: 400px; margin: 0;">
                            Each piece is individually finished in our Yogyakarta studio. We avoid mass manufacturing to
                            preserve quality and craftsmanship in every pennant.
                        </p>
                    </div>
                </div>
                <!-- Process 2 -->
                <div class="swiper-slide about-process__item">
                    <div style="padding: 60px 40px; height: 100%;">
                        <span
                            ...
                            — The Approach</span>
                        <h3 style="font-size: 24px; font-weight: 700; text-transform: uppercase; margin: 0 0 20px 0;">Small
                            Batches</h3>
                        <p style="font-size: 13px; font-weight: 300; line-height: 1.6; max-width: 400px; margin: 0;">
                            Produced in limited small batches. We take our time to source materials and carefully construct
                            items that are built for collectors and explorers alike.
                        </p>
                    </div>
                </div>
                <!-- Process 3 -->
    ...
    <section style="display: grid; grid-template-columns: 1fr;">
        ...
        <div
            ...
            <!-- <a href="/shop"
                    ...
                    View Collection <span style="margin-left: 8px;">&rarr;</span>
                </a> -->
            <div class="pby__links">
                <a href="/shop" class="pby__link">View Collection</a>
