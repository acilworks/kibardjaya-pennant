...
@section('title', 'Custom Banner - Kibardjaya')
...
@section('content')
<section class="pdp" x-data="bannerCustomizer()">
    <!-- LEFT: Product Preview -->
    <div class="pdp__gallery cp-gallery">
        <div class="cp-preview" id="banner-preview-container">
            <!-- Capture Area for Canvas API -->
            <div id="capture-area" class="cp-capture cp-capture--banner">
        ...
        <div class="pdp__info-box">
            <div class="pdp__info-inner">
                ...
                <div class="pdp__header">
                    <h1 class="pdp__title">Custom Banner -</h1>
                    <span class="pdp__price">Rp.149.000</span>
                </div>

                {{-- Description --}}
                <p class="pdp__desc">Design your own custom banner!</p>
                <p class="pdp__desc">Create a timeless rectangular banner for your favorite beach, mountain, lake,
                    hiking trail,
                    etc.</p>
                <p class="pdp__desc cp-desc--spaced">Choose your flag color, border color, and text... we will build
                    your custom banner for you.</p>
                ...
                <form @submit.prevent="submitToCart">
                    ...
                    <div class="pdp__colors">
                        <div class="cp-text-row">
                            ...
                            <span class="cp-text-counter">10 Characters, 3 lines max</span>
                        </div>
                        <textarea x-model="text" @input="limitText" class="cp-input" rows="3"
                            placeholder="your&#10;magic&#10;words"
                    ...
                    <input type="hidden" name="id" value="custom-banner-001">
                </form>
            </div>
...
<section class="custom-ideas">
    ...
    @if(isset($latestBanners) && count($latestBanners) > 0)
    <div class="swiper custom-ideas-swiper-top custom-ideas__swiper">
        <div class="swiper-wrapper" style="transition-timing-function: linear;">
            @foreach($latestBanners as $img)
            <div class="swiper-slide custom-ideas__slide">
                <img src="{{ asset($img) }}" alt="Custom Banner Idea" loading="lazy">
            </div>
            @endforeach
        </div>
    </div>
        ...
        Alpine.data('bannerCustomizer', () => ({
            ...
            get currentFlagImage() {
                if (this.flagColor && this.borderColor) {
                    return `/images/pennant_parts/banner/banner-${this.flagColor}-${this.borderColor}.webp`;
                }
                return '';
            },
            ...
            async submitToCart() {
                ...
                try {
                    ...
                    const response = await fetch('/cart/add-custom-banner', {
                        method: 'POST',
                        headers: {
